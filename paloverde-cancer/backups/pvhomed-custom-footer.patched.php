...
.eit-footer__credit { display: inline-flex; align-items: center; color: #6e7177 !important; font-size: 12.5px !important; font-weight: 500 !important; line-height: 1.45 !important; opacity: 1 !important; }
.eit-footer__credit a { color: #0f2a42 !important; font-weight: 700 !important; text-decoration: none; opacity: 1 !important; }
.eit-footer__credit a:hover { color: #ee8b2d !important; }
.eit-footer__credit-wrap { display: inline-flex; align-items: center; gap: 7px; }
.eit-footer__globe3d { position: relative; width: 11px; height: 11px; display: inline-block; flex: 0 0 11px; border-radius: 50%; background: radial-gradient(circle at 30% 30%, rgba(255,255,255,.95) 0 12%, rgba(255,255,255,.15) 13% 22%, transparent 23%), radial-gradient(circle at 35% 35%, #7fd3ff 0, #3889d9 38%, #174278 72%, #0d1e39 100%); box-shadow: inset -2px -3px 5px rgba(0,0,0,.35), inset 2px 2px 4px rgba(255,255,255,.12), 0 0 0 1px rgba(255,255,255,.08); overflow: visible; animation: eit-footer-globe-spin 8s linear infinite; }
.eit-footer__globe3d:before, .eit-footer__globe3d:after { position: absolute; inset: 0; content: ""; border-radius: 50%; }
.eit-footer__globe3d:before { inset: 1px 3px; border-left: 1px solid rgba(255,255,255,.5); border-right: 1px solid rgba(255,255,255,.25); transform: rotate(18deg); opacity: .7; }
.eit-footer__globe3d:after { inset: 3px 1px; border-top: 1px solid rgba(255,255,255,.38); border-bottom: 1px solid rgba(255,255,255,.2); opacity: .75; }
.eit-footer__globe3d-orbit { position: absolute; left: 50%; top: 50%; width: 16px; height: 6px; margin-left: -8px; margin-top: -3px; border: 1px solid rgba(238,139,45,.55); border-radius: 50%; transform: rotate(-25deg); opacity: .9; animation: eit-footer-orbit-tilt 3s linear infinite; }
.eit-footer__globe3d-orbit:before { position: absolute; top: 50%; left: -1px; width: 2.5px; height: 2.5px; margin-top: -1.25px; content: ""; border-radius: 50%; background: #f3ad68; box-shadow: 0 0 8px rgba(238,139,45,.45); animation: eit-footer-orbit-dot 3s linear infinite; }
@keyframes eit-footer-globe-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
@keyframes eit-footer-orbit-tilt { from { transform: rotate(-25deg) rotateY(0deg); } to { transform: rotate(-25deg) rotateY(360deg); } }
@keyframes eit-footer-orbit-dot { 0% { left: -1.25px; opacity: .95; transform: scale(1); } 25% { left: calc(50% - 1.25px); opacity: .7; transform: scale(.8); } 50% { left: calc(100% - 1.25px); opacity: .95; transform: scale(1); } 75% { left: calc(50% - 1.25px); opacity: .4; transform: scale(.65); } 100% { left: -1.25px; opacity: .95; transform: scale(1); } }
...
<footer class="pvhomed-footer">
  ...
  <div class="footer-bottom">
    <div class="footer-bottom-inner">
      ...
      <div class="eit-footer__credit">
        <span class="eit-footer__credit-wrap">
          <span>Website by <a href="https://azwebcorp.com/" target="_blank" rel="noopener">AZWebCorp</a></span>
          <span class="eit-footer__globe3d" aria-hidden="true"><span class="eit-footer__globe3d-orbit"></span></span>
        </span>
      </div>
    </div>
  </div>
