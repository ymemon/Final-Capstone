...
function azwc_ss_checkout_form( $product_id, $plan_name ) {
    ...
    <form class="azwc-ss-checkout" method="post" action="<?php echo esc_url( AZWC_SS_CART_ACTION ); ?>">
        ...
        <button type="submit" aria-label="Continue to secure checkout for <?php echo esc_attr( $plan_name ); ?>">
...
#azwc-ss,#azwc-ss *{box-sizing:border-box}#azwc-ss a{color:inherit;text-decoration:none}#azwc-ss svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.8}#azwc-ss .azwc-shell{width:min(1180px,calc(100% - 48px));margin:0 auto}#azwc-ss .azwc-kicker{margin:0 0 17px;color:#9b7000;font-size:11px;font-weight:850;letter-spacing:.16em;text-transform:uppercase}#azwc-ss .azwc-kicker.light{color:var(--yellow2)}#azwc-ss h1,#azwc-ss h2,#azwc-ss h3,#azwc-ss p{margin-top:0}#azwc-ss h1{max-width:820px;margin-bottom:24px;font-size:clamp(46px,6.4vw,82px);font-weight:650;line-height:.98;letter-spacing:-.06em}#azwc-ss h1 em{color:var(--yellow2);font-style:normal}#azwc-ss .azwc-heading{margin-bottom:0;font-size:clamp(35px,4vw,56px);font-weight:640;line-height:1.04;letter-spacing:-.05em}#azwc-ss .azwc-heading em{color:#987000;font-style:normal}
...
#azwc-ss .azwc-final{padding:72px 0;color:#fff;background:#0b192e}#azwc-ss .azwc-final-grid{display:flex;align-items:center;justify-content:space-between;gap:35px}#azwc-ss .azwc-final h2{max-width:710px;margin:0;font-size:clamp(28px,3vw,42px);line-height:1.08;letter-spacing:-.04em}#azwc-ss .azwc-final p{margin:12px 0 0;color:#aab6c8;font-size:13px}#azwc-ss .azwc-final a{min-height:48px;display:inline-flex;align-items:center;justify-content:center;padding:0 21px;color:#172238;background:var(--yellow);border-radius:10px;font-size:11px;font-weight:850;white-space:nowrap}
...
@media(max-width:767px){#azwc-ss .azwc-shell{width:min(100% - 30px,1180px)}#azwc-ss .azwc-product-nav .azwc-shell{overflow-x:auto}#azwc-ss .azwc-product-label,#azwc-ss .azwc-product-nav a{min-height:54px;padding:0 15px;white-space:nowrap}#azwc-ss .azwc-product-label{padding-left:0}#azwc-ss .azwc-hero{min-height:auto;padding:75px 0 70px}#azwc-ss .azwc-hero-grid{grid-template-columns:1fr}#azwc-ss .azwc-hero h1{font-size:clamp(42px,13vw,62px)}#azwc-ss .azwc-hero-copy>p{font-size:15px}#azwc-ss .azwc-security-orb{width:280px;margin-top:20px}#azwc-ss .azwc-hero-icon{width:102px;height:102px;border-radius:28px}#azwc-ss .azwc-hero-icon svg{width:48px;height:48px}#azwc-ss .azwc-orbit-tag{font-size:8px}#azwc-ss .azwc-confidence-grid{grid-template-columns:1fr}#azwc-ss .azwc-confidence-item,#azwc-ss .azwc-confidence-item:last-child{border-right:0;border-left:0;border-bottom:1px solid rgba(19,37,62,.11)}#azwc-ss .azwc-plans,#azwc-ss .azwc-explain,#azwc-ss .azwc-faq{padding:82px 0}#azwc-ss .azwc-plan,#azwc-ss .azwc-ssl-grid .azwc-plan{display:block;padding:25px 21px}#azwc-ss .azwc-ssl-grid .azwc-features{margin-top:25px;padding:24px 0 0;border-top:1px solid #e5e7ea;border-left:0}#azwc-ss .azwc-ssl-grid .popular .azwc-features{border-top-color:rgba(255,255,255,.13);border-left:0}#azwc-ss .azwc-explain-grid,#azwc-ss .azwc-faq-grid{grid-template-columns:1fr;gap:42px}#azwc-ss .azwc-final-grid{display:block}#azwc-ss .azwc-final a{margin-top:25px}}
...
function azwc_ss_hero( $type ) {
    ...
    ?>
    <section class="azwc-hero">
        <div class="azwc-shell azwc-hero-grid">
            <div class="azwc-hero-copy">
                <p class="azwc-kicker light"><?php echo $is_security ? 'Website defense, made manageable' : 'Trusted encryption without the confusion'; ?></p>
                <?php if ( $is_security ) : ?>
                    <h1>Protect your website <em>before trouble starts.</em></h1>
                    <p>A secure website should not require a security department. Put a firewall, malware monitoring, cleanup support and dependable backups around your business—without adding another complicated dashboard to your day.</p>
                <?php else : ?>
                    <h1>SSL certificates, <em>made simple.</em></h1>
                    <p>Give customers the encrypted HTTPS connection they expect. Choose affordable self-managed coverage or automated certificate care that handles installation changes and lifecycle monitoring for you.</p>
                <?php endif; ?>
                <ul class="azwc-hero-trust">
                    <li><?php echo azwc_ss_icon( 'check' ); ?> Verified reseller pricing</li>
                    <li><?php echo azwc_ss_icon( 'check' ); ?> Secure GoDaddy-powered checkout</li>
                    <li><?php echo azwc_ss_icon( 'check' ); ?> Coverage that can grow with you</li>
                </ul>
            </div>
            <div class="azwc-security-orb" aria-hidden="true">
                <div class="azwc-hero-icon"><?php echo azwc_ss_icon( $is_security ? 'shield' : 'lock' ); ?></div>
                <span class="azwc-orbit-tag azwc-tag-a"><?php echo azwc_ss_icon( $is_security ? 'scan' : 'shield' ); ?> <?php echo $is_security ? 'Malware scanning' : 'SHA-2 encryption'; ?></span>
                <span class="azwc-orbit-tag azwc-tag-b"><?php echo azwc_ss_icon( $is_security ? 'speed' : 'scan' ); ?> <?php echo $is_security ? 'DDoS + CDN' : 'Change monitoring'; ?></span>
                <span class="azwc-orbit-tag azwc-tag-c"><?php echo azwc_ss_icon( $is_security ? 'backup' : 'globe' ); ?> <?php echo $is_security ? 'Secure backups' : 'HTTPS confidence'; ?></span>
            </div>
        </div>
    </section>
    <?php
...
function azwc_ss_render_security_plans() {
    ...
    <section class="azwc-plans" id="plans"><div class="azwc-shell">
        <div class="azwc-section-intro">
            <p class="azwc-kicker">Three clear levels of protection</p>
            <h2 class="azwc-heading">Choose the protection your <em>website actually needs.</em></h2>
            <p>Every plan protects one website. Move up when you need unlimited cleanup, DDoS defense, faster delivery through a CDN or more backup capacity.</p>
        </div>
        <div class="azwc-plan-grid">
            <?php foreach ( $plans as $plan ) : $popular = ! empty( $plan['popular'] ); ?>
                <article class="azwc-plan <?php echo $popular ? 'popular' : ''; ?>">
                    <?php if ( $popular ) : ?><span class="azwc-popular">Most popular</span><?php endif; ?>
                    <span class="azwc-plan-label">Per website</span>
                    <h3><?php echo esc_html( $plan['name'] ); ?></h3>
                    <p class="azwc-plan-summary"><?php echo esc_html( $plan['summary'] ); ?></p>
                    <div class="azwc-price"><sup>$</sup><strong><?php echo esc_html( $plan['price'] ); ?></strong><span>/ month</span></div>
                    <div class="azwc-scope">Billed for one protected site</div>
                    <?php echo azwc_ss_checkout_form( $plan['product'], $plan['name'] . ' Website Security' ); ?>
                    <ul class="azwc-features">
                        <?php foreach ( $plan['features'] as $feature ) : ?><li><?php echo azwc_ss_icon( 'check' ); ?><span><?php echo esc_html( $feature ); ?></span></li><?php endforeach; ?>
                    </ul>
                </article>
            <?php endforeach; ?>
        </div>
...
function azwc_ss_render_ssl_plans() {
    ...
    <section class="azwc-plans" id="plans"><div class="azwc-shell">
        <div class="azwc-section-intro">
            <p class="azwc-kicker">Domain Validation SSL</p>
            <h2 class="azwc-heading">The right certificate for <em>the way you manage.</em></h2>
            <p>Basic plans keep the price low when you can manage installation yourself. Automated plans add guided setup, monitoring and ongoing lifecycle management.</p>
        </div>
        <div class="azwc-plan-grid azwc-ssl-grid">
            <?php foreach ( $plans as $plan ) : $popular = ! empty( $plan['popular'] ); ?>
                <article class="azwc-plan <?php echo $popular ? 'popular' : ''; ?>">
                    <?php if ( $popular ) : ?><span class="azwc-popular">Best for less maintenance</span><?php endif; ?>
                    <div class="azwc-plan-left">
                        <span class="azwc-plan-label"><?php echo esc_html( $plan['tier'] ); ?></span>
                        <h3><?php echo esc_html( $plan['name'] ); ?></h3>
                        <p class="azwc-plan-summary"><?php echo esc_html( $plan['summary'] ); ?></p>
                        <div class="azwc-price"><sup>$</sup><strong><?php echo esc_html( $plan['price'] ); ?></strong><span>/ year</span></div>
