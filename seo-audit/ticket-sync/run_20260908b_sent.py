...
CHECKPOINT_DT = parsedate_to_datetime("Tue, 8 Sep 2026 05:16:15 -0500")
...
ids = data[0].split()
print("Sent candidates (SINCE 08-Sep-2026):", ids)
...
with open("run_20260908b_sent_out.json", "w", encoding="utf-8") as f:
