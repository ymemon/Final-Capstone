...
CHECKPOINT_UID = 8690
CHECKPOINT_DT = parsedate_to_datetime("Sun, 06 Sep 2026 04:28:22 +0000")
...
def fetch_folder(M, folder, checkpoint_uid=None, checkpoint_dt=None):
    ...
    if checkpoint_uid is not None:
        ...
        typ, data = M.search(None, 'SINCE "04-Sep-2026"')
    uids = data[0].split()
    results = []
...
with open("run_20260906_sync_current.json", "w", encoding="utf-8") as f:
