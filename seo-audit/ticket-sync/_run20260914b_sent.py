...
# checkpoint date: 2026-09-14 08:42:11 UTC
typ, data = M.search(None, 'SINCE', '13-Sep-2026')
uids = data[0].split()
print("Candidate UIDs (SINCE 13-Sep-2026):", uids)
...
json.dump(results, open("_run20260914b_sent_out.json", "w", encoding="utf-8"), indent=2)
