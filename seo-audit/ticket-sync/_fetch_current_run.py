...
sent_msgs, sent_max_uid, sent_max_date, sent_uidnext = fetch_folder(M, "Sent", dt_gt=CHECKPOINT_DT)
...
with open("_fetch_current_run_out.json", "w", encoding="utf-8") as f:
    json.dump(out, f, indent=2, ensure_ascii=False)
print("inbox new:", len(inbox_msgs), "uidnext:", inbox_uidnext)
print("sent new:", len(sent_msgs), "uidnext:", sent_uidnext)
