...
with open("_fetch_sent9_out.json", "w", encoding="utf-8") as f:
    json.dump(out, f, indent=2, ensure_ascii=False)

print("sent new messages:", len(results))
print("max uid:", max_uid, "max date:", max_date)
for m in results:
    print(m["uid"], m["to"], "|", m["subject"])
