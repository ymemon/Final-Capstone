...
# IMAP SINCE is date-granularity only; use a day early then filter precisely by Date header.
...
with open("run_20260913_0940_sent_out.json", "w", encoding="utf-8") as f:
