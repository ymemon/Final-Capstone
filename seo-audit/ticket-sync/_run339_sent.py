import imaplib, json, email, datetime
...
cutoff = parsedate_to_datetime("Mon, 14 Sep 2026 08:42:11 +0000")
...
json.dump(results, open("_run339_sent_out.json", "w", encoding="utf-8"), indent=2)
