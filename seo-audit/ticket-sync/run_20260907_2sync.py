...
uids = data[0].split()
inbox_msgs, inbox_max_uid, inbox_max_date = extract(M, uids, CHECKPOINT_UID, use_uid=True)
...
if sent_folder:
    ...
    uids2 = data[0].split()
    sent_msgs, sent_max_uid, sent_max_date = extract(M, uids2, None, use_uid=False, checkpoint_dt=CHECKPOINT_DT)
...
with open("run_20260907_2sync.json", "w", encoding="utf-8") as f:
