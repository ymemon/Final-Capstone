...
CHECKPOINT_UID = 8769
CHECKPOINT_DT = parsedate_to_datetime("Tue, 8 Sep 2026 16:27:06 +0000")

DRAFTS_EXCLUDE = {"drafts"}
...
def fetch_folder(M, folder, checkpoint_uid=None, checkpoint_dt=None):
    ...
    if checkpoint_uid is not None:
        ...
        typ, data = M.uid('search', None, 'SINCE "08-Sep-2026"')
    uids = data[0].split()
    results = []
...
with open("r0908c_out.json", "w", encoding="utf-8") as f:
