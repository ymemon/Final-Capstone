...
CHECKPOINT_UID = 4085
CHECKPOINT_DT = parsedate_to_datetime("Sat, 12 Sep 2026 22:37:07 +0000 (UTC)")
...
out = {
    "folders": [f.decode(errors='replace') for f in folder_list],
...
with open("run_20260912_2354_out.json", "w", encoding="utf-8") as f:
