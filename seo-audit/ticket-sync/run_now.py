...
CHECKPOINT_UID = 8642
CHECKPOINT_DATE_STR = "Wed, 02 Sep 2026 19:31:43 +0000"
checkpoint_dt = parsedate_to_datetime(CHECKPOINT_DATE_STR)
if checkpoint_dt.tzinfo is None:
    checkpoint_dt = checkpoint_dt.replace(tzinfo=datetime.timezone.utc)
...
try:
    ...
    since_str = (checkpoint_dt.date() - datetime.timedelta(days=1)).strftime("%d-%b-%Y")
...
with open("run_now.json", "w", encoding="utf-8") as f:
