...
CHECKPOINT_UID = 4081
CHECKPOINT_DT = parsedate_to_datetime("Sat, 12 Sep 2026 21:24:35 +0000")
...
sent_msgs, sent_max_uid, sent_max_date = fetch_folder(M, "Sent", dt_gt=CHECKPOINT_DT)
...
with open("_run_20260912_1500_out.json", "w", encoding="utf-8") as f:
    json.dump(out, f, indent=2, ensure_ascii=False)
print("inbox new:", len(inbox_msgs))
