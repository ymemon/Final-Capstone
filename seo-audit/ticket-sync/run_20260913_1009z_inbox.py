...
print("UIDs strictly newer than checkpoint:", uids)
...
with open("run_20260913_1009z_inbox_out.json", "w", encoding="utf-8") as f:
    json.dump(results, f, indent=2, ensure_ascii=False)

print("Total genuinely new messages:", len(results))
