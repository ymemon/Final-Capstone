...
CHECKPOINT_UID = 4078
CHECKPOINT_DT = parsedate_to_datetime("Sat, 12 Sep 2026 17:14:07 +0000")
...
out = {
    "folders": [f.decode(errors='replace') if isinstance(f, bytes) else str(f) for f in folders],
...
with open("run_20260912_run4_out.json", "w", encoding="utf-8") as f:
