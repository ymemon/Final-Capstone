...
CHECKPOINT_UID = 8739
CHECKPOINT_DT = parsedate_to_datetime("Mon, 7 Sep 2026 12:06:49 +0000")
...
if sent_folder:
    ...
    since_str = (CHECKPOINT_DT - datetime.timedelta(days=2)).strftime("%d-%b-%Y")
...
with open("run_20260907_1225utc.json", "w", encoding="utf-8") as f:
