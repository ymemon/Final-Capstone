...
CHECKPOINT_UID = 8664
CHECKPOINT_DATE_STR = "Thu, 03 Sep 2026 18:06:57 +0000 (UTC)"
...
try:
    ...
    typ, data = M.uid('search', None, 'SINCE', '02-Sep-2026')
...
with open("run_20260903_1224.json", "w", encoding="utf-8") as f:
