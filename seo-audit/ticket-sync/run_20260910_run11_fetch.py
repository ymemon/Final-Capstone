...
CHECKPOINT_UID = 8827
CHECKPOINT_DT = parsedate_to_datetime("Thu, 10 Sep 2026 08:56:24 +0000")
...
def fetch_folder(M, folder, checkpoint_uid=None, checkpoint_dt=None):
    ...
    if checkpoint_uid is not None:
        ...
        typ, data = M.search(None, 'SINCE "08-Sep-2026"')
    uids = data[0].split()
    results = []
...
sent_msgs, sent_max_uid, sent_max_date = fetch_folder(M, "Sent", checkpoint_dt=CHECKPOINT_DT)
...
with open("run_20260910_run11_fetch.json", "w", encoding="utf-8") as f:
